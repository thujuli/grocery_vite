...
function CardCategory(props) {
  ...
  return (
    <div
      ...
      className={`relative max-w-64 h-[304px] px-8 pt-8 pb-6 rounded-md bg-orange-200 ${bgColor} text-center transition-all duration-300 ease-in-out hover:cursor-pointer hover:h-[340px] group`}
